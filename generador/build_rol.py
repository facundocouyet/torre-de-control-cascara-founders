...
partes.append(S("00","Para qué es este documento",
  ...
  P("Está escrito para leerse una vez y después consultarse. El resto del proceso —las diez llamadas, las "
    "orientaciones, el handicap, las grupales— vive en el documento de proceso; acá está solamente tu lugar adentro "
    "de ese proceso.","sub")))
...
partes.append(S("02","El ritmo",
  ...
  RITMO([
    ...
    ("Cada tres meses","Se revisan los cortes del handicap, el precio y la forma de la oferta con todos los founders "
...
partes.append(S("03","Las llamadas que son tuyas",
  ...
  TABLA(["Cuándo","Qué se resuelve","Con qué llega el founder"],[
   ...
   ["Semana 3","<b>Selección de foco.</b> Una sola orientación, con el handicap adelante.",
...
partes.append(S("04","La torre de control",
  P("Es la página donde viven los founders activos: los veintidós casos ordenados por handicap, el detalle de cada uno con su "
  ...
  BLOQ([
    ("Lo que se actualiza solo",
     ...
     "únicamente lo que esa llamada cambió, recalcula el handicap y vuelve a publicar la página y los documentos. "
     "También escribe el Update en la ficha de Cuentas en Notion."),
    ("Lo que depende de vos",
     "El handicap lo calcula el sistema, pero los cortes y los anclajes los fijás vos. La orientación se propone "
...
partes.append(S("07","Cómo se presenta un informe",
  ...
  PASOS([
    ...
    "<b>El handicap queda adentro.</b> Va en las radiografías y sale de los informes de cierre, que son los que se "
    "mandan.",
...
partes.append(S("08","Procesos de la oferta de Founders",
  ...
  TABLA(["Proceso","Se dispara con","Qué queda hecho","Dueño"],[
   ...
   ["<b>Revisión de la oferta</b>","Cada tres meses","Los cortes del handicap revisados, el precio con Franco y la forma de la oferta.","Facu"],
  ]) +
...
partes.append(S("09","Qué hace el agente",
  ...
  BLOQ([
    ...
    ("Después de cada llamada",
     ...
     "en Cuentas y prepara el mensaje corto para el grupo. Recalcula el handicap y republica la torre."),
    ("Los lunes, además",
...
open('/home/claude/rol/rol-lider-founders.html','w',encoding='utf-8').write(HTML)
print("ok",len(HTML))
